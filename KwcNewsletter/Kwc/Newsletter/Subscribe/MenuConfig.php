<?php
class KwcNewsletter_Kwc_Newsletter_Subscribe_MenuConfig extends Kwf_Component_Abstract_MenuConfig_Abstract
{
    ...
    public function addResources(Kwf_Acl $acl)
    {
        ...
        foreach ($components as $c) {
            ...
            $acl->add(new KwcNewsletter_Kwc_Newsletter_Subscribe_Resource($this->_class.$c->dbId,
                $menuConfig,
    ...
    {
        return 'KwcNewsletter_Kwc_Newsletter_Subscribe_MenuConfigEvents';
    }
}
