<?php
class KwcNewsletter_Kwc_Newsletter_Subscribe_Update_20170819SubscriberLogState extends Kwf_Update
{
    public function postUpdate()
    {
        parent::postUpdate();
        foreach (Kwf_Component_Data_Root::getInstance()->getComponentsByClass('KwcNewsletter_Kwc_Newsletter_Component') as $c) {
            $keywords = array(
