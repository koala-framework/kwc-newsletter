<?php
class KwcNewsletter_Kwc_Newsletter_Subscribe_RecipientController extends Kwf_Controller_Action_Auto_Form
{
    protected $_permissions = array('save', 'add');
    protected $_formName = 'KwcNewsletter_Kwc_Newsletter_EditSubscriber_Form';
    ...
    protected function _afterInsert(Kwf_Model_Row_Interface $row)
    {
        ...
        $subscribeData = $root->getComponentByClass('KwcNewsletter_Kwc_Newsletter_Subscribe_Component', array('ignoreVisible' => true, 'subroot' => $nlData->getSubroot()));
