<?php
class KwcNewsletter_Kwc_Newsletter_Subscribe_MenuConfigEvents extends Kwf_Component_Abstract_MenuConfig_Events
{
    public function getListeners()
    {
        $ret = parent::getListeners();
        foreach (Kwc_Abstract::getComponentClasses() as $c) {
            if (is_instance_of($c, 'KwcNewsletter_Kwc_Newsletter_Component')) {
                $ret[] = array(
                    'class' => $c,
