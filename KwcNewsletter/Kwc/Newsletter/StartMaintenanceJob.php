<?php
class KwcNewsletter_Kwc_Newsletter_StartMaintenanceJob extends Kwf_Util_Maintenance_Job_Abstract
{
    ...
    {
        $model = Kwf_Model_Abstract::getInstance('KwcNewsletter_Kwc_Newsletter_Model');
