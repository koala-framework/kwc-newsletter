<?php
class KwcNewsletter_Kwc_Newsletter_Detail_RecipientController extends KwcNewsletter_Kwc_Newsletter_Subscribe_RecipientController
{
    protected $_formName = 'KwcNewsletter_Kwc_Newsletter_EditSubscriber_FrontendForm';
