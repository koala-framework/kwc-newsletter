<?php
class KwcNewsletter_Kwc_Newsletter_Detail_Mail_Paragraphs_LinkTag_Activation_Component
    extends KwcNewsletter_Kwc_Newsletter_Detail_Mail_Paragraphs_LinkTag_Abstract_Component
{
    ...
    protected function _getTargetComponent() {
        return Kwf_Component_Data_Root::getInstance()->getComponentByClass(
            'KwcNewsletter_Kwc_Newsletter_Subscribe_DoubleOptIn_Component', array('subroot' => $this->_getNewsletterComponent()->getSubroot())
        );
    }
}
