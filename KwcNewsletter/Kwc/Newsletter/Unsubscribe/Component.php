<?php
class KwcNewsletter_Kwc_Newsletter_Unsubscribe_Component extends Kwc_Abstract_Composite_Component
{
    ...
    public static function getSettings($param = null)
    {
        ...
        $ret['generators']['child']['component']['form'] = 'KwcNewsletter_Kwc_Newsletter_Unsubscribe_Form_Component';
