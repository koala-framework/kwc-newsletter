<?php
class KwcNewsletter_Kwc_Newsletter_Unsubscribe_Form_Component extends Kwc_Form_Component
{
    ...
    public function processInput(array $postData)
    {
        if (!$this->_recipient && isset($postData['d'])) {
            ...
            if (count($params) >= 4 && $params[3] == $this->_getHash(array(
                ...
                $c = Kwf_Component_Data_Root::getInstance()->getComponentByClass('KwcNewsletter_Kwc_Newsletter_Detail_Mail_Component', array(
                    'limit' => 1,
