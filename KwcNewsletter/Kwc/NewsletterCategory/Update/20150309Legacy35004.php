<?php
class KwcNewsletter_Kwc_NewsletterCategory_Update_20150309Legacy35004 extends Kwf_Update
{
    ...
    public function postUpdate()
    {
        if ($this->_afterUpdateRequired) {
            $c = Kwf_Component_Data_Root::getInstance()
                ->getComponentByClass('KwcNewsletter_Kwc_NewsletterCategory_Component', array('limit'=>1));
            Kwf_Registry::get('db')
